...
function CityAnimation() {
  return (
    <div className="city-animation">
      <div className="content page-max-width">
        <div className="sun" />
        ...
        <div className="building">
          ...
          <DataPoint delay={0.65} data={{ x1: 20, y1: 20, x2: 75, y2: -75 }} />
        ...
        <div className="industry">
          ...
          <DataPoint delay={0.25} data={{ x1: 220, y1: 0, x2: 135, y2: -175 }} />
          <DataPoint delay={0.05} data={{ x1: 210, y1: 0, x2: 135, y2: -175 }} />
          <DataPoint delay={0.55} data={{ x1: 265, y1: 0, x2: 135, y2: -175 }} />
        </div>

        <div className="hospital">
          <SVGHospital width="150px" />
